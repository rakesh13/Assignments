...
public class DataMungerTest {
	...
	@Test
	public void testWhereWithMultipleConditionLogicalOperators()
	{
		QueryParser queryParser=query.executeQuery("select * from Employee.csv where dept=HR and Salary>=35000 or Name=Pankaj");
		assertEquals(3,queryParser.getRestrictionList().size());
		System.out.println("logical Operator List :"+queryParser.getLogicalOperators());
	}
